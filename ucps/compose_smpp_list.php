...
<body>
                ...
                <div class="col-lg-4">
                  <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                      ...
                      <li class="breadcrumb-item">
                        <a href="compose_smpp_list">Compose SMPP List</a>
                      </li>
                    </ul>
                  </div>
                </div>
  ...
  <script>
    ...
    function find_template_list() {
      $.ajax({
        type: 'post',
        url: "ajax/display_functions.php?call_function=template_list_SMPP",
        dataType: 'html',
    ...
    function remove_template(template_response_id, indicatori) {
      ...
      $.ajax({
        type: 'post',
        url: "ajax/whatsapp_call_functions.php?tmpl_call_function=remove_template_smpp" + send_code,
        dataType: 'json',
