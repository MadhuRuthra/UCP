$(document).ready(function() {
    ...
    $('#footer-search tfoot th').each(function() {
        ...
        // if(title != '#' && title != 'Action') {
            $(this).html('<input type="text" class="form-control" title="Type to Search ' + title + '" style="width: 100%; padding: 2px 0px; margin: 5px 0px; height: 25px;" placeholder="Search ' + title + '" />');
        /* } else {
            $(this).html('');
        } */
    });
