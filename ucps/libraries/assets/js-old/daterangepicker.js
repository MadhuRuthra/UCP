class DateRangePicker {
    ...
    static #generateYearSelector(instance, tableContainer) {
        ...
        divInputContainer.innerHTML = `
            <input class="cal-year-input" name="year-input" type="number" min="1900" max="2099" step="1" placeholder="Search"/>
            <button type="button" class="cal-btn-select-year">Choose</button>
        `;
