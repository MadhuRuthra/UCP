												...
												<div class="card-body">
													<form method="post">
														<div id="table-1_filter" class="dataTables_filter">
															<!-- date filter -->
															<div style="width: 20%; padding-right:1%; float: left;">Date :<input type="search"
																	name="dates" id="dates" value="<?= $_REQUEST['dates'] ?>"
															...
															<div style="width: 20%; padding-right:1%; float: left;">
																<input type="submit" name="submit_1" id="submit_1" tabindex="10" value="Search"
																	class="btn btn-success " style="height:40px; margin-top: 20px;">
															</div>
														</div>
													</form>
...
<script type="text/javascript" src="libraries\bower_components\bootstrap-daterangepicker\js\daterangepicker.js"></script>
    ...
    function business_summary_report() {
      ...
      $.ajax({
        type: 'post',
        url: "ajax/display_functions.php?call_function=business_summary_report_smpp&dates=" + dates,
        dataType: 'html',
        beforeSend: function () {
          $('.theme-loader').show();
        },
