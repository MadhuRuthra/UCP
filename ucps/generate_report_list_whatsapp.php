...
<head>
    ...
    <title> Generate Report List Whatsapp ::
...
<body>
                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Generate Report Whatsapp</h5>
                                ...
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                        <ul class=" breadcrumb breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="">Generate Report Whatsapp</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    function find_approve_template() {
        $.ajax({
            type: 'post',
            url: "ajax/display_functions.php?call_function=generate_report_list_whatsapp",
            dataType: 'html',
    ...
    function func_save_phbabt(compose_whatsapp_id, user_id) {
        ...
        $.ajax({
            type: 'post',
            url: "ajax/message_call_functions.php?tmpl_call_function=generate_report_whatsapp" + send_code,
            ...
            success: function(response) { // Success
                ...
                if (response.status == 0) {
                    ...
                    $('#id_approved_lineno_').html(
                        '<a href="javascript:void(0)" class="btn disabled btn-outline-success">' +
                        response.msg + '</a>');
                    setTimeout(function() {
                        window.location = 'generate_report_list_whatsapp';
                    }, 1000);
                } else { // Success
                    console.log("else");
                    $('#id_approved_lineno_').html(
                        '<a href="javascript:void(0)" class="btn disabled btn-outline-success">Success</a>'
                        );
                    setTimeout(function() {
                        window.location = 'generate_report_list_whatsapp';
