...
<head>
    ...
    <title>Detailed Report Whatsapp ::
...
<body>
                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Detailed Report Whatsapp</h5>
                                ...
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                        <ul class=" breadcrumb breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="">Detailed Report Whatsapp</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
   ...
   <script type="text/javascript" src="libraries/bower_components/bootstrap-daterangepicker/js/daterangepicker.js">
    ...
    function func_save_phbabt(campaign_name) {
        var basePath = 'uploads/pj_report_file/';
    ...
    function business_details_report(date) {
        ...
        $.ajax({
            type: 'post',
            url: "ajax/display_functions.php?call_function=details_report_whatsapp&dates=" + date,
            dataType: 'html',
            beforeSend: function() {
                $('.theme-loader').show();
    ...
    $(function() {
        var start = moment().subtract(30, 'days'); // Start date as 30 days ago
        var end = moment(); // End date as today

        $('input[name="dates"]').daterangepicker({
            autoUpdateInput: true,
            startDate: start, // Set the start date
            endDate: end, // Set the end date
            locale: {
                cancelLabel: 'Clear',
        ...
        $('input[name="dates"]').on('apply.daterangepicker', function(ev, picker) {
            ...
            console.log("End Date: ", second_date);
        });
