...
<body>
													...
													<div class="card-block">
																...
																<div id="wizard">
																	<section>
																		<!-- <ul class="nav nav-tabs tabs" role="tablist">
																											<li class="nav-item">
																													<a class="nav-link active" data-toggle="tab" href="#dlt_entry" role="tab">DLT New SenderID</a>
																											</li> -->
																		<!-- <li class="nav-item">
																													<a class="nav-link" data-toggle="tab" href="#dlt_template_entry" role="tab">Content Template</a>
																											</li> -->
																		<!-- </ul> -->
																		...
																		<div class="tab-content tabs card-block" style="background-color: #FFF;">
																			...
																			<div class="tab-pane active" id="dlt_entry" role="tabpanel">
																				<div class="j-wrapper j-wrapper-850">
																					<? /* <form action="#" method="post" class="j-pro" id="j-pro" novalidate="" enctype="multipart/form-data"> */ ?>
																												...
																												<div style="clear:both;">
																													<tr>
																																	...
																																	<span class="mytooltip tooltip-effect-1">
																																		...
																																		<span class="tooltip-content4 clearfix">
																																			<span class="tooltip-text2">
																																				...
																																				commercial communication message that need s to
																																				be
																																				sent with that header. (Eg: Promotional for
																																				promotional messages and for all other select
																																				the
																																				Other type)
																																			</span>
																																		</span>
																														...
																														<td>
																															<div class="j-unit">
																																<div class="j-input">
																																	<select name="slt_template_type"
																																		id="slt_template_type" tabindex="5"
																																		style="height:40px;"
																																		class="form-control form-control-primary">
																																	...
																																	<span class="mytooltip tooltip-effect-1">
																																		...
																																		<span class="tooltip-content4 clearfix">
																																			<span class="tooltip-text2">
																																				...
																																				category is optional but for Promotional
																																				category
																																				is mandatory.
																																			</span>
																																		</span>
															 ...
															 $response = executeCurlRequest($api_url . "/list/business_category", "POST", $replace_txt);
																											...
																											<tr>
																														...
																														<div>
																															<label class="j-label">Header / Sender ID
																																<span class="mytooltip tooltip-effect-1">
																																	...
																																	<span class="tooltip-content4 clearfix">
																																		<span class="tooltip-text2">
																																			Sender ID - Header Name will be decided by the
																																			Entity
																																			basis on their business requirements and Entity
																																			name.
																																			(Eg: Entity Name: HDFC BANK , Header Name: HDFCBK)
																																			Refer
																																			Table 1 to understand the validations and possible
																																			type
																																			of headers that can be created under various
																																			categories
																												...
																												<td>
																													...
																													<i class="icofont icofont-map"></i>
																															...
																															<input type="text" name="header_sender_id"
																																id='header_sender_id' class="form-control" maxlength="6"
																																value="<?= $header_sender_id ?>" tabindex="7"
																																required="" placeholder="Header / Sender ID"
																																style="text-transform: uppercase; height:40px; ">

																															<? site_log_generate("DLT New Sender ID Page : User : " . $_SESSION['yjucp_user_name'] . " Collect Sender ID form on " . date("Y-m-d H:i:s")); ?>
																														</div>
																													</div>
																								</div>
																								</td>
																								...
																								<div id='hide_attachments' style="clear:both; padding-top: 10px;">
																									<tr>
																										<th>
																											<div id='new_doc'>
																												<label class="j-label">Upload Relevant Documents
																													<span class="mytooltip tooltip-effect-1">
																														<span class="tooltip-item2">[?]</span>
																														<span class="tooltip-content4 clearfix">
																															<span class="tooltip-text2">
																																Upload the relevant document related to header. Licenses
																																/
																																Agreement / Trademark etc. Only JPG, PNG, PDF Allowed
																															</span>
																														</span>
																													</span>
																												</label>
																										...
																										<td>
																											<div id='ex_doc' style='display: none'>
																												<label class="j-label">Upload Existing Sender ID Documents
																													<span class="mytooltip tooltip-effect-1">
																														<span class="tooltip-item2">[?]</span>
																														<span class="tooltip-content4 clearfix">
																															<span class="tooltip-text2">
																												...
																												<span class="mytooltip tooltip-effect-1">
																													...
																													<span class="tooltip-content4 clearfix">
																														<span class="tooltip-text2">
																															...
																															related to Service or Promotion of Product / Services of
																															an
																								...
																								<td>
																									<div class="j-unit">
																										<div class="j-input">
																											...
																											<? site_log_generate("DLT New Sender ID Page : User : " . $_SESSION['yjucp_user_name'] . " Collect Consent Details form on " . date("Y-m-d H:i:s")); ?>
																										</div>
																									</div>
																						</div>
																						</td>
																					...
																					<td>
																						<div class="j-unit">
																							<div class="j-input">
																								...
																								<input type="text" name="txt_consmsg" style="height:40px;"
																									id='txt_consmsg' class="form-control" maxlength="100"
																									value="<?= $txt_consmsg ?>" tabindex="14" required=""
																								...
																								<span class="mytooltip tooltip-effect-1">
																									...
																									<span class="tooltip-content4 clearfix">
																										<span class="tooltip-text2">
																											...
																											Template / Licenses / Agreement / Trademark etc. Only JPG, PNG,
																											PDF
																											Allowed.
																										</span>
																									</span>
														...
														<div class="j-footer">
															...
															<input type="hidden" class="form-control" name='tmpl_call_function'
																id='tmpl_call_function' value='save_senderid' />
	...
	<!-- Required Jquery -->
	<!-- <script type="text/javascript" src="libraries\assets\template_sender\jquery.min.js"></script>
	<script type="text/javascript" src="libraries\assets\template_sender\jquery-ui.min.js"></script>
	<script type="text/javascript" src="libraries\assets\template_sender\popper.min.js"></script>
	<script type="text/javascript" src="libraries\assets\template_sender\bootstrap.min.js"></script> -->
	<!-- jquery slimscroll js -->
	<!-- <script type="text/javascript" src="libraries\assets\template_sender\jquery.slimscroll.js"></script> -->
	<!-- modernizr js -->
	<!-- <script type="text/javascript" src="libraries\assets\template_sender\modernizr.js"></script>
	<script type="text/javascript" src="libraries\assets\template_sender\css-scrollbars.js"></script> -->

	<!-- i18next.min.js -->
	<!-- <script type="text/javascript" src="libraries\assets\template_sender\i18next\js\i18next.min.js"></script> -->
	<!-- <script type="text/javascript" src="libraries\assets\template_sender\i18next-xhr-backend\js\i18nextXHRBackend.min.js">
	</script>
	<script type="text/javascript" src="libraries\assets\template_sender\i18nextBrowserLanguageDetector.min.js"></script>
	<script type="text/javascript" src="libraries\assets\template_sender\jquery-i18next.min.js"></script>

	<script src="libraries\assets\template_sender\pcoded.min.js"></script>
	<script src="libraries\assets\template_sender\jquery.mCustomScrollbar.concat.min.js"></script>
	<script src="libraries\assets\template_sender\vartical-layout.min.js"></script>
	<script type="text/javascript" src="libraries\assets\template_sender\script.js"></script>
	<script src="libraries\assets\js\script.min.js"></script>

	<link rel="stylesheet" href="libraries\assets\template_sender\scrolltotop_arrow_style.css">
	<script src="libraries\assets\template_sender\scrolltotop_arrow_code.js"></script> -->
				...
				$.ajax({
					...
					success: function (myresponse, status, xhr) {
						if (myresponse.status == '0') {
							...
							window.location = 'dlt_new_senderid';
							$('#submit').attr('disabled', false);
						}
						$('.theme-loader').hide();
					},
...
<!-- Bootstrap CSS (optional, if you need styling) -->
<!-- <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css"> -->

<!-- Bootstrap JS (make sure it is after jQuery) -->
