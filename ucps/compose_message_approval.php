...
<body>
                ...
                <div class="col-lg-4">
                  <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                      ...
                      <li class="breadcrumb-item">
                        <a href="">Compose Message Approve</a>
                      </li>
                    </ul>
                  </div>
                </div>
  ...
  <script>
    ...
    function func_save_phbabt(user_id, compose_id, indicatori) {
      ...
      $.ajax({
        type: 'post',
        url: "ajax/message_call_functions.php?tmpl_call_function=approve_compose" + send_code,
        dataType: 'json',
        beforeSend: function () {
          $('.theme-loader').show();
        },
    ...
    function change_status(compose_message_id, user_id, approve_status, indicatori) {
      ...
      $.ajax({
        type: 'post',
        url: "ajax/message_call_functions.php?tmpl_call_function=reject_campaign_sms" + send_code,
        dataType: 'json',
