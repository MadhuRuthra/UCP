...
<head>
	...
	<title>Content Template - Existing ::
		<?= $site_title ?>
	</title>
							...
							<div class="row align-items-end">
								<div class="col-lg-8">
									<div class="page-header-title">
										...
										<div class="d-inline">
											<h5>Content Template - Existing</h5>
								...
								<div class="col-lg-4">
									<div class="page-header-breadcrumb">
										<ul class=" breadcrumb breadcrumb-title">
											...
											<li class="breadcrumb-item">
												<a href="">Content Template - Existing</a>
											</li>
										</ul>
									</div>
								</div>
								...
								<div class="page-wrapper">
									...
									<div class="page-body">
																							...
																							<div class="row">
																								...
																								<div class="col-lg-6">
																									...
																									<div style="clear:both; display: none;">
																										...
																										<div class="j-unit">
																											<select name="cn_template_buscategory"
																												id="cn_template_buscategory"
																												class="form-control form-control-primary">
																												<? 
									 ...
									 $response = executeCurlRequest($api_url . "/list/content_template_business", "POST", $replace_txt);
                                                              ...
                                                              $replace_txt = '';
                                                               // Call the reusable cURL function
                                                                $response = executeCurlRequest($api_url . "/list/content_template_headersenderid_exist", "POST", $replace_txt);
                                                              // Decode the response and check for JSON errors
																															$sql_routmast = json_decode($response);
																															if (json_last_error() !== JSON_ERROR_NONE) {
																																echo "<option>Error in JSON response</option>";
																																site_log_generate("JSON Decode Error: " . json_last_error_msg(), '../');
																															} elseif (!empty($sql_routmast->result)) {
                                                          ...
                                                          $response = executeCurlRequest($api_url . "/list/consenttmpl_exists", "POST", $replace_txt);
																								...
																								<div class="j-unit">
																									<div class="j-input">
																										...
																										<input type="text" name="cn_template_name" id='cn_template_name'
																											...
																											value="<?=$cn_template_name?>" tabindex="10" required=""
																											placeholder="Content Template Name">
																										<? site_log_generate("Content Template - Existing Page : User : ".$_SESSION['yjucp_user_name']." Collect Content Details form on ".date("Y-m-d H:i:s")); ?>
																									</div>
																								</div>
																				</div>
																				</td>
																				...
																				<tr>
																							...
																							<div>
																								<label class="j-label">Content Template Message
																									<span class="mytooltip tooltip-effect-1">
																										...
																										<span class="tooltip-content4 clearfix">
																											<span class="tooltip-text2">
																												Your New Content Template Message with all formatting. In
																												this Box, type the required content and to add variables
																												there are options available on the panel.
																											</span>
																										</span>
																									</span>
																								</label>
																					...
																					<td>
																						<div class="j-unit">
																							<div class="j-input">
																								<textarea id="cn_message" name="cn_message" tabindex="11"
																									maxlength="1000" class="form-control form-control-primary required"
			...
			$.ajax({
				...
				success: function(myresponse, status, xhr) {
					if (myresponse.status == '0') {
						...
						$("#id_error_display").html("Existing Template Created..");
						window.location = 'content_template_existing';
						$('#submit').attr('disabled', false);
					}
					$('.theme-loader').hide();
				},
			...
			$.ajax({
				...
				success: function(response) {
					if (response.status == '0') {
						...
						$('#submit_template').attr('disabled', false);
						$("#id_error_displays").html("Existing Template Created..");
						window.location = 'content_template_existing';
					}
					$('.theme-loader').hide();
