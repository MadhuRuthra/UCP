...
site_log_generate("Template List Page : Unknown User : '" . $_SESSION['yjucp_user_id'] . "' access this page on " . date("Y-m-d H:i:s"));
?>
<!DOCTYPE html>
<html lang="en">
<!-- Added by HTTrack -->
...
<body>
						...
						<div class="pcoded-inner-content">
							...
							<div class="main-body">
								...
								<div class="section-body">
									...
									<div class="row">
										<div class="col-12">
											<h4 class="text-right"><a href="create_template" class="btn btn-success"><i
														class="fas fa-plus"></i>
									...
									<div class="col-12">
										<div class="card">
											<!-- Choose User -->
											<div class="card-body">
												<div class="table-responsive" id="id_template_list">
													Loading…
												</div>
											</div>
										</div>
  ...
  <script>
    ...
    function find_template_list() {
      $.ajax({
        type: 'post',
        url: "ajax/display_functions.php?call_function=template_list_whsp",
        dataType: 'html',
